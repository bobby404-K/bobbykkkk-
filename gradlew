...
# Resolve GRADLE_HOME, APP_HOME, and JAVA_HOME based on script location
APP_NAME="Gradle"
...
#     double quotes to make sure that they are handled correctly. Quoting
#     prevents word-splitting, empty string is dropped.
#   * The remaining arguments from the command line are interpolated.
